...
<html lang="en">
  <head>
	...
	<link rel="stylesheet" type="text/css" href="css/listHoliday.css">
  ...
  <body>
	...
	<div id="main" class="container">
		<h4 class="page-header">Listagem de Feriados</h4>
			...
			<div class="table-responsive col-md-12">
				<table class="table table-striped" cellspacing="0" cellpadding="0">
					...
					<tbody>
						<tr>
							<td>001</td>
								<td>Greve dos Caminhoneiros</td>
								<td>13/05/2018 a 25/05/2018</td>
								<td class="actions">
									<a type="submit" class="btn btn-primary" href="editHoliday.html">Editar</button></a>
								</td>
								<td class="actions">
			...
			<div class="row">
				<div class="col-md-12">
					<a type="submit" class="btn btn-success" href="registerHoliday.html">Adicionar</button></a>
				</div>
			</div>
		</div> 
	</div>
